...
const weeklyProducts = [
  ...
  [
    ...
    },
    {
      ...
      editorPick: false, publishDate: TODAY, slug: "ghd-platinum-plus-hair-straightener-review",
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      shortDescription: "24K gold barrel curling iron with extra-long barrel for faster styling and long-lasting curls.",
      fullReview: `Hot Tools Pro Artist 24K Gold Extra Long Curling Iron is a professional-grade tool that has been a salon staple for decades. The 24K gold barrel heats quickly and evenly, and the extra-long barrel length allows for larger sections, making it faster to curl a full head of hair than standard-length irons. The gold barrel creates a smooth glide that reduces friction and protects the hair cuticle.\n\nWe tested this on medium-thickness, shoulder-length hair and found it excellent for creating classic, polished curls. The curls produced are consistent, shiny, and long-lasting. The multiple heat settings (from 280°F to 430°F) accommodate different hair types, and the professional-grade construction feels durable and reliable.\n\nAt $40, it's exceptional value for a professional-grade tool. Hot Tools Pro Artist 24K Gold is our top recommendation for those who want classic, polished curls at a budget-friendly price.`,
