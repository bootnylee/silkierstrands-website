...
const weeklyProducts = [
  ...
  [
    ...
    },
    {
      ...
      name: "Verb Ghost Flat Iron",
      brand: "Verb",
      asin: "B09NWQMHVM",
      price: 95.00, priceDisplay: "$95.00",
      rating: 4.6, reviewCount: 3400,
      category: "Flat Irons & Straighteners", categorySlug: "flat-irons",
      imageUrl: "https://m.media-amazon.com/images/I/71Xt9PQJVZL._SL1500_.jpg",
      amazonImageUrl: "https://m.media-amazon.com/images/I/71Xt9PQJVZL._SL1500_.jpg",
      hairTypes: ["fine", "normal", "color-treated"],
      shortDescription: "Lightweight flat iron with ghost technology for smooth results with minimal heat damage.",
      fullReview: `Verb Ghost Flat Iron has quickly become a cult favorite in the clean beauty space, and after testing it, we understand the enthusiasm. The Ghost technology uses a lower temperature range (up to 380°F) combined with ultra-smooth ceramic plates to achieve smooth results with significantly less heat damage than conventional flat irons.\n\nWe tested this on fine, color-treated hair and found it exceptional at achieving smooth, shiny results without the brittleness that often follows heat styling. The lightweight design (just 0.7 lbs) makes it comfortable for extended use, and the 60-second heat-up time is fast.\n\nAt $95, it's competitively priced for the quality delivered. The Verb Ghost is our top recommendation for those with fine or color-treated hair who want to minimize heat damage without sacrificing results.`,
      pros: ["Lower temperature range minimizes damage", "Ultra-smooth ceramic plates", "Lightweight design", "Excellent for fine and color-treated hair"],
      cons: ["Lower max temperature may not work on very thick hair", "Not as widely available as major brands", "Limited heat settings"],
      bestFor: "Fine, color-treated, or heat-damaged hair; those prioritizing hair health",
      editorPick: false, publishDate: TODAY, slug: "verb-ghost-flat-iron-review",
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      name: "Bio Ionic GoldPro Speed Dryer",
      brand: "Bio Ionic",
      asin: "B00AQNFME0",
      price: 199.00, priceDisplay: "$199.00",
